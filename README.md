...
- **Constant region identification**: human and mouse with alignments showing similarity to wildtype constant regions. Human IgG (IGHG1–4) CH alignments include an **EU numbering** row (Edelman / EU index via [IMGT Hu_IGHGnber](https://imgt.org/IMGTScientificChart/Numbering/Hu_IGHGnber.html)) above the raw residue ruler, after isotype determination.
...
<img src="screenshot_single_mab_analysis.png" alt="Screenshot of single mAb analysis" width="1200" height="1220">

## Screenshot - Multiple mAb Analysis

<img src="screenshot_multiple_mab_analysis.png" alt="Screenshot of multiple mAb analysis" width="1200" height="1200">
